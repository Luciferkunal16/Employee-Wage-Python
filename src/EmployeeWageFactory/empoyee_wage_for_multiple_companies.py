...
class ComputeEmployeeWageMultipleCompanies(EmployeeWageInterface):

    def calculate_employee_wage_for_company(self, company_name, emp_rate, num_of_days, max_hours):
        """
        ...
        print("Employee Wage Per Month for company -{} is {}".format(company_name, emp_wage_per_month))
    ...
    def initialize(self):
        ...
        try:
            print("Welcome to the Employee Wage Computation program for Multiple Companies")
            num_of_companies = int(input("Enter the Number of Companies"))
            for i in range(0, num_of_companies):
                ...
                emp_wage_per_month = self.calculate_employee_wage_for_company(company_name, emp_rate, num_of_days,
                                                                              max_hours)
